...
You may have a Python interpreter with an unsupported version. The published Taichi Forge 0.6.2 release provides 64-bit wheels for Python 3.10 through 3.14. For more information about installation-specific issues, see [Installation Troubleshooting](./install.md).
