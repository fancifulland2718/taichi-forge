...
The C++ part of the Taichi compiler is written in C++17, and the supported
Forge wheel line starts at Python 3.10. You can assume that C++17 and Python
3.10 features are available.
