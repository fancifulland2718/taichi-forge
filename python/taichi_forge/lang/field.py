...
from taichi_forge._logging import warn
...
class Field:
    ...
    def _snode(self):
        ...
        Returns:
            SNode: Representative SNode (SNode of first field member).
        """
        return taichi_forge.lang.snode.SNode(self.vars[0].ptr.snode())
    ...
    def __str__(self):
        if taichi_forge.lang.impl.inside_kernel():
    ...
    def _initialize_host_accessors(self):
        if self.host_accessors:
            return
        taichi_forge.lang.impl.get_runtime().materialize()
