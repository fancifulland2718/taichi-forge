...
from taichi_forge.lang import ops as ops_mod
from taichi_forge.lang import runtime_ops
from taichi_forge.lang._ndarray import Ndarray, NdarrayHostAccess
from taichi_forge.lang.common_ops import TaichiOperations
...
class Matrix(TaichiOperations):
    ...
    Args:
        ...
        dt (:mod:`~taichi_forge.types.primitive_types`): the element data type.
    ...
    def __matmul__(self, other):
        ...
        """
        from taichi_forge.lang import matrix_ops  # pylint: disable=C0415
    ...
    def cast(self, dtype):
        ...
        Args:
            dtype (:mod:`~taichi_forge.types.primitive_types`): data type of the
                returned matrix.

        Returns:
            :class:`taichi_forge.Matrix`: A new matrix with the specified data dtype.
    ...
    def trace(self):
        ...
        from taichi_forge.lang import matrix_ops
    ...
    def inverse(self):
        ...
        Returns:
            :class:`~taichi_forge.Matrix`: The inverse of a matrix.
    ...
    def transpose(self):
        ...
        Returns:
            :class:`~taichi_forge.Matrix`: The transpose of this matrix.
    ...
    def diag(dim, val):
        ...
        Returns:
            :class:`~taichi_forge.Matrix`: The wanted diagonal matrix.
    ...
    def norm_inv(self, eps=0):
        """The inverse of the matrix :func:`~taichi_forge.lang.matrix.Matrix.norm`.
    ...
    def zero(dt, n, m=None):
        ...
        Returns:
            :class:`~taichi_forge.lang.matrix.Matrix`: A :class:`~taichi_forge.lang.matrix.Matrix` instance filled with zeros.
    ...
    def one(dt, n, m=None):
        ...
        Returns:
            :class:`~taichi_forge.lang.matrix.Matrix`: A :class:`~taichi_forge.lang.matrix.Matrix` instance filled with ones.
    ...
    def unit(n, i, dt=None):
        ...
        Args:
            ...
            dt (:mod:`~taichi_forge.types.primitive_types`, optional): The desired data type.

        Returns:
            :class:`~taichi_forge.Matrix`: The returned vector.
    ...
    def identity(dt, n):
        ...
        Returns:
            :class:`~taichi_forge.Matrix`: An `n x n` identity matrix.
        """
        from taichi_forge.lang import matrix_ops  # pylint: disable=C0415
    ...
    def field(
        ...
        Returns:
            :class:`~taichi_forge.Matrix`: A matrix.
        """
        entries = []
    ...
    def dot(self, other):
        ...
        Args:
            other (:class:`~taichi_forge.Matrix`): The input Vector.
    ...
    def cross(self, other):
        ...
        Returns:
            :class:`~taichi_forge.Matrix`: The cross product of the two Vectors.
        """
        from taichi_forge.lang import matrix_ops  # pylint: disable=C0415
    ...
    def outer_product(self, other):
        ...
        Returns:
            :class:`~taichi_forge.Matrix`: The outer product of the two Vectors.
        """
        from taichi_forge.lang import matrix_ops  # pylint: disable=C0415
...
class Vector(Matrix):
    def __init__(self, arr, dt=None, **kwargs):
        ...
        Args:
            ...
            dt (:mod:`~taichi_forge.types.primitive_types`): data type of the vector.

        Returns:
            :class:`~taichi_forge.Matrix`: A vector instance.
        Example::
            >>> u = ti.Vector([1, 2])
...
class MatrixField(Field):
    ...
    def to_torch(self, device=None, keep_dims=False):
        ...
        Args:
            ...
            keep_dims (bool, optional): Whether to keep the dimension after conversion.
                See :meth:`~taichi_forge.lang.field.MatrixField.to_numpy` for more detailed explanation.
...
class MatrixNdarray(Ndarray):
    ...
    def _fill_by_kernel(self, val):
        from taichi_forge._kernels import fill_ndarray_matrix  # pylint: disable=C0415
