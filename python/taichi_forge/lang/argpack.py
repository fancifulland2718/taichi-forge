...
from taichi_forge.lang.util import in_python_scope, python_scope
import numpy as np
...
from taichi_forge.lang.struct import StructType, Struct
    ...
    def _write_to_device(self, needed, provided, v, index):
        if isinstance(needed, ArgPackType):
            ...
            if id(needed) in primitive_types.real_type_ids:
                ...
                pass
            elif isinstance(needed, ndarray_type.NdarrayType) and isinstance(v, taichi_forge.lang._ndarray.Ndarray):
                pass
            elif isinstance(needed, texture_type.TextureType) and isinstance(v, taichi_forge.lang._texture.Texture):
                pass
            elif isinstance(needed, texture_type.RWTextureType) and isinstance(v, taichi_forge.lang._texture.Texture):
                pass
