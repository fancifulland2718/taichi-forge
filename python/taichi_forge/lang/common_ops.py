...
from taichi_forge.lang.util import in_python_scope
from taichi_forge.types import primitive_types
from typing import TYPE_CHECKING


class TaichiOperations:
    """The base class of taichi operations of expressions. Subclasses: :class:`~taichi_forge.lang.expr.Expr`, :class:`~taichi_forge.lang.matrix.Matrix`"""
    ...
    def _atomic_add(self, other):
        ...
        Returns:
            :class:`~taichi_forge.lang.expr.Expr`: The computing expression of atomic add."""
    ...
    def _atomic_mul(self, other):
        ...
        Returns:
            :class:`~taichi_forge.lang.expr.Expr`: The computing expression of atomic mul."""
    ...
    def _atomic_sub(self, other):
        ...
        Returns:
            :class:`~taichi_forge.lang.expr.Expr`: The computing expression of atomic sub."""
    ...
    def _atomic_and(self, other):
        ...
        Returns:
            :class:`~taichi_forge.lang.expr.Expr`: The computing expression of atomic and."""
    ...
    def _atomic_xor(self, other):
        ...
        Returns:
            :class:`~taichi_forge.lang.expr.Expr`: The computing expression of atomic xor."""
    ...
    def _atomic_or(self, other):
        ...
        Returns:
            :class:`~taichi_forge.lang.expr.Expr`: The computing expression of atomic or."""
    ...
    def _assign(self, other):
        ...
        Returns:
            :class:`~taichi_forge.lang.expr.Expr`: The expression after assigning."""
