...
from taichi_forge.types.primitive_types import f32, f64, i32, i64

from taichi_forge import _logging, _snode, _version_check

warnings.filterwarnings("once", category=DeprecationWarning, module="taichi_forge")
...
def init(
    ...
    **kwargs,
    ...
    Args:
        arch: Backend to use. This is usually :const:`~taichi_forge.lang.cpu` or :const:`~taichi_forge.lang.gpu`.
