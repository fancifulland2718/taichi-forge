...
from taichi_forge.lang import expr, impl
from taichi_forge.lang.exception import TaichiSyntaxError
from taichi_forge.lang.field import Field
from taichi_forge.lang.util import cook_dtype, is_matrix_class, is_taichi_class, taichi_scope
...
def cast(obj, dtype):
    ...
    Args:
        obj (Union[:mod:`~taichi_forge.types.primitive_types`, :class:`~taichi_forge.Matrix`]): \
            Input scalar or matrix.

        dtype (:mod:`~taichi_forge.types.primitive_types`): A primitive type defined in :mod:`~taichi_forge.types.primitive_types`.
...
def bit_cast(obj, dtype):
    ...
    Args:
        obj (:mod:`~taichi_forge.types.primitive_types`): Input scalar.

        dtype (:mod:`~taichi_forge.types.primitive_types`): Target data type, must have \
...
def _unary_operation(taichi_op, python_op, a):
    ...
    from taichi_forge.lang.matrix import Matrix  # pylint: disable-msg=C0415
...
def neg(x):
    ...
    Args:
        x (Union[:mod:`~taichi_forge.types.primitive_types`, :class:`~taichi_forge.Matrix`]): \
            Input scalar or matrix.
...
def cos(x):
    ...
    Args:
        x (Union[:mod:`~taichi_forge.type.primitive_types`, :class:`~taichi_forge.Matrix`]): \
            Angle, in radians.
...
def round(x, dtype=None):  # pylint: disable=redefined-builtin
    ...
    Args:
        ...
        dtype: (:mod:`~taichi_forge.types.primitive_types`): the returned type, default to `None`. If \
...
def bit_not(a):
    ...
    Args:
        a (Union[:class:`~taichi_forge.lang.expr.Expr`, :class:`~taichi_forge.lang.matrix.Matrix`]): A number or a matrix.
...
def random(dtype=float) -> Union[float, int]:
    ...
    Args:
        dtype (:mod:`~taichi_forge.types.primitive_types`): Type of the required random value.
...
def add(a, b):
    ...
    Args:
        a (Union[:class:`~taichi_forge.lang.expr.Expr`, :class:`~taichi_forge.lang.matrix.Matrix`]): A number or a matrix.
        b (Union[:class:`~taichi_forge.lang.expr.Expr`, :class:`~taichi_forge.lang.matrix.Matrix`]): A number or a matrix.
...
def mod(x1, x2):
    ...
    Args:
        x1 (Union[:mod:`~taichi_forge.types.primitive_types`, :class:`~taichi_forge.Matrix`]): \
            Dividend scalar or matrix.

        x2 (Union[:mod:`~taichi_forge.types.primitive_types`, :class:`~taichi_forge.Matrix`]): \
...
def pow(base, exponent):  # pylint: disable=W0622
    ...
    Args:
        base (Union[:mod:`~taichi_forge.types.primitive_types`, :class:`~taichi_forge.Matrix`]): \
            The bases.
        exponent (Union[:mod:`~taichi_forge.types.primitive_types`, :class:`~taichi_forge.Matrix`]): \
            The exponents.
...
def floordiv(a, b):
    ...
    Args:
        a (Union[:class:`~taichi_forge.lang.expr.Expr`, :class:`~taichi_forge.lang.matrix.Matrix`]): A number or a matrix.
        b (Union[:class:`~taichi_forge.lang.expr.Expr`, :class:`~taichi_forge.lang.matrix.Matrix`]): A number or a matrix with elements not equal to zero.
...
def raw_div(x1, x2):
    ...
    Args:
        x1 (Union[:mod:`~taichi_forge.types.primitive_types`, :class:`~taichi_forge.Matrix`]): Dividend.
        x2 (Union[:mod:`~taichi_forge.types.primitive_types`, :class:`~taichi_forge.Matrix`]): Divisor.
...
def cmp_lt(a, b):
    ...
    Args:
        a (Union[:class:`~taichi_forge.lang.expr.Expr`, :class:`~taichi_forge.lang.matrix.Matrix`]): value LHS
        b (Union[:class:`~taichi_forge.lang.expr.Expr`, :class:`~taichi_forge.lang.matrix.Matrix`]): value RHS

    Returns:
        Union[:class:`~taichi_forge.lang.expr.Expr`, bool]: True if LHS is strictly smaller than RHS, False otherwise
...
def cmp_le(a, b):
    ...
    Returns:
        Union[:class:`~taichi_forge.lang.expr.Expr`, bool]: True if LHS is smaller than or equal to RHS, False otherwise
...
def cmp_gt(a, b):
    ...
    Returns:
        Union[:class:`~taichi_forge.lang.expr.Expr`, bool]: True if LHS is strictly larger than RHS, False otherwise
...
def cmp_eq(a, b):
    ...
    Returns:
        Union[:class:`~taichi_forge.lang.expr.Expr`, bool]: True if LHS is equal to RHS, False otherwise.
...
def cmp_ne(a, b):
    ...
    Returns:
        Union[:class:`~taichi_forge.lang.expr.Expr`, bool]: True if LHS is not equal to RHS, False otherwise
...
def bit_or(a, b):
    ...
    Returns:
        Union[:class:`~taichi_forge.lang.expr.Expr`, bool]: LHS bitwise-or with RHS
...
def bit_and(a, b):
    ...
    Returns:
        Union[:class:`~taichi_forge.lang.expr.Expr`, bool]: LHS bitwise-and with RHS
...
def bit_xor(a, b):
    ...
    Returns:
        Union[:class:`~taichi_forge.lang.expr.Expr`, bool]: LHS bitwise-xor with RHS
...
def bit_shl(a, b):
    ...
    Returns:
        Union[:class:`~taichi_forge.lang.expr.Expr`, int]: LHS << RHS
...
def logical_and(a, b):
    ...
    Returns:
        Union[:class:`~taichi_forge.lang.expr.Expr`, bool]: LHS logical-and RHS (with short-circuit semantics)
...
def logical_or(a, b):
    ...
    Returns:
        Union[:class:`~taichi_forge.lang.expr.Expr`, bool]: LHS logical-or RHS (with short-circuit semantics)
...
def select(cond, x1, x2):
    ...
    Args:
        cond (Union[:mod:`~taichi_forge.types.primitive_types`, :class:`~taichi_forge.Matrix`]): \
            The array of conditions.
        x1, x2 (Union[:mod:`~taichi_forge.types.primitive_types`, :class:`~taichi_forge.Matrix`]): \
...
def ifte(cond, x1, x2):
    ...
    Args:
        cond (:mod:`~taichi_forge.types.primitive_types`): \
            The condition.
        x1, x2 (:mod:`~taichi_forge.types.primitive_types`): \
            The outputs.
...
def atomic_add(x, y):
    ...
    Args:
        x, y (Union[:mod:`~taichi_forge.types.primitive_types`, :class:`~taichi_forge.Matrix`]): \
            The input.
...
def max(*args):  # pylint: disable=W0622
    ...
    Args:
        args: (List[:mod:`~taichi_forge.types.primitive_types`, :class:`~taichi_forge.Matrix`]): \
            The input.
