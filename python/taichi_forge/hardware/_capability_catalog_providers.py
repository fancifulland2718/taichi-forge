    ...
    return (
        ...
        _operation(
            ...
            notes=(
                ...
                "No complete-recipe FFT search family, automatic provider route, R2C/C2R, or arbitrary strides.",
