...
def d1_provider_operations(_operation):
    return (
        ...
        _operation(
            ...
            public_api="ti.hardware.linalg.CudssPlan",
            ...
            notes=(
                "Explicit Python-scope provider; SparseSolver and Taichi kernels are never rewritten to call cuDSS.",
                ...
                "Graph recording is excluded because the initial slice uses cuDSS default allocation and staged host API calls.",
            ),
        ),
    )
