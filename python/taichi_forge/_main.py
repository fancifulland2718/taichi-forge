...
from taichi_forge._lib import utils
from taichi_forge.lang import impl
from taichi_forge.tools import diagnose, video
...
class TaichiMain:
    ...
    def _get_friend_links():
        return (
            ...
            "Forum:  https://forum.taichi_forge.graphics/\n"
        )
    ...
    def repl(arguments: list = sys.argv[2:]):
        """Start Taichi REPL / Python shell with 'import taichi_forge as ti'"""
    ...
    def module(self, arguments: list = sys.argv[2:]):
        """Taichi module tools"""
        from taichi_forge import _ti_module  # pylint: disable=C0415
