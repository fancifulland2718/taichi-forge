...
def matrix(n=None, m=None, dtype=None):
    ...
    Args:
        ...
        dtype (:mod:`~taichi_forge.types.primitive_types`): matrix data type.
    ...
    """
    return taichi_forge.lang.matrix.MatrixType(n, m, 2, dtype)
...
def vector(n=None, dtype=None):
    ...
    Args:
        ...
        dtype (:mod:`~taichi_forge.types.primitive_types`): vector data type.
    ...
    """
    return taichi_forge.lang.matrix.VectorType(n, dtype)
...
def struct(**kwargs):
    ...
    """
    return taichi_forge.lang.struct.StructType(**kwargs)
...
def argpack(**kwargs):
    ...
    Example::
        ...
        >>> s = sphere(center=vec3([0., 0., 0.]), radius=1.0)
    """
    return taichi_forge.lang.argpack.ArgPackType(**kwargs)
