...
from taichi_forge.lang import impl, snode
from taichi_forge.lang.exception import TaichiRuntimeError
from taichi_forge.lang.util import warning
...
class FieldsBuilder:
    ...
    def deactivate_all(self):
        """Same as :func:`taichi_forge.lang.snode.SNode.deactivate_all`"""
        if self.finalized:
    ...
    def dense(
        ...
        """Same as :func:`taichi_forge.lang.snode.SNode.dense`"""
    ...
    def dynamic(
        ...
        """Same as :func:`taichi_forge.lang.snode.SNode.dynamic`"""
        if not _ti_core.is_extension_supported(impl.current_cfg().arch, _ti_core.Extension.sparse):
    ...
    def bitmasked(
        ...
        """Same as :func:`taichi_forge.lang.snode.SNode.bitmasked`"""
        if not _ti_core.is_extension_supported(impl.current_cfg().arch, _ti_core.Extension.sparse):
    ...
    def quant_array(
        ...
        """Same as :func:`taichi_forge.lang.snode.SNode.quant_array`"""
        self._check_not_finalized()
        self.empty = False
    ...
    def place(self, *args: Any, offset: Optional[Union[Sequence[int], int]] = None):
        """Same as :func:`taichi_forge.lang.snode.SNode.place`"""
        self._check_not_finalized()
        self.empty = False
        self.root.place(*args, offset=offset)

    def lazy_grad(self):
        """Same as :func:`taichi_forge.lang.snode.SNode.lazy_grad`"""
    ...
    def _allocate_adjoint_checkbit(self):
        """Same as :func:`taichi_forge.lang.snode.SNode._allocate_adjoint_checkbit`"""
        self._check_not_finalized()
        self.empty = False
        self.root._allocate_adjoint_checkbit()

    def lazy_dual(self):
        """Same as :func:`taichi_forge.lang.snode.SNode.lazy_dual`"""
        # TODO: This complicates the implementation. Figure out why we need this
        self._check_not_finalized()
        self.empty = False
        self.root.lazy_dual()
