...
from taichi_forge._kernels import tensor_to_image, vector_to_fast_image, vector_to_image
...
class GUI:
    ...
    Returns:
        :class:`~taichi_forge.misc.gui.GUI` :The created taichi GUI object.
    ...
    def slider(self, text, minimum, maximum, step=1):
        ...
        Return:
            :class:`~taichi_forge.misc.gui.GUI.WidgetValue` :The created slider object.
        """
    ...
    def label(self, text):
        ...
        Return:
            :class:`~taichi_forge.misc.gui.GUI.WidgetValue` :The created label object.
    ...
    def set_image(self, img):
        ...
        Args:
            img (Union[:class:`taichi_forge.field`, `numpy.array`]): The color array \
        ...
        if self.fast_gui:
            assert isinstance(
                img, taichi_forge.lang.matrix.MatrixField
        ...
        elif isinstance(img, taichi_forge.lang.matrix.MatrixField):
    ...
    def get_events(self, *e_filter):
        ...
        Returns:
            :class:`~taichi_forge.misc.gui.GUI.EVENT`: A list of events that are triggered.
        """
    ...
    def get_key_event(self):
        ...
        Returns:
            :class:`~taichi_forge.misc.gui.GUI.EVENT`: The keyboard triggered event.
        """
