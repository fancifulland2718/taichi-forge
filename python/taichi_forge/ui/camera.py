...
class Camera:
    ...
    def position(self, x, y, z):
        ...
        Args:
            args (:mod:`taichi_forge.types.primitive_types`): 3D coordinates.
    ...
    def fov(self, fov):
        ...
        Args:
            fov (:mod:`taichi_forge.types.primitive_types`): Angle in range (0, 180).
    ...
    def left(self, left):
        ...
        Args:
            left (:mod:`taichi_forge.types.primitive_types`): \
    ...
    def right(self, right):
        ...
        Args:
            right (:mod:`taichi_forge.types.primitive_types`): \
    ...
    def top(self, top):
        ...
        Args:
            top (:mod:`taichi_forge.types.primitive_types`): \
    ...
    def bottom(self, bottom):
        ...
        Args:
            bottom (:mod:`taichi_forge.types.primitive_types`): \
    ...
    def z_near(self, z_near):
        ...
        Args:
            near (:mod:`taichi_forge.types.primitive_types`): \
    ...
    def z_far(self, z_far):
        ...
        Args:
            far (:mod:`taichi_forge.types.primitive_types`): \
    ...
    def get_projection_matrix(self, aspect):
        ...
        Args:
            aspect (:mod:`taichi_forge.types.primitive_types`): \
    ...
    def track_user_inputs(
        ...
        Args:
            ...
            window (:class:`~taichi_forge.ui.Window`): a windown instance.
            movement_speed (:mod:`~taichi_forge.types.primitive_types`): camera movement speed.
            yaw_speed (:mod:`~taichi_forge.types.primitive_types`): speed of changes in yaw angle.
            pitch_speed (:mod:`~taichi_forge.types.primitive_types`): speed of changes in pitch angle.
            hold_key (:mod:`~taichi_forge.ui`): User defined key for holding the camera movement.
        """
