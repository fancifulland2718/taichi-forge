...
class CuptiMetric:
    """A class to add CUPTI metric for :class:`~taichi_forge.profiler.kernel_profiler.KernelProfiler`.
    ...
    For usage of this class, see examples in func :func:`~taichi_forge.profiler.set_kernel_profiler_metrics` and :func:`~taichi_forge.profiler.collect_kernel_profiler_metrics`.

    Args:
        name (str): name of metric that collected by CUPTI toolkit. used by :func:`~taichi_forge.profiler.set_kernel_profiler_metrics` and :func:`~taichi_forge.profiler.collect_kernel_profiler_metrics`.
        header (str): column header of this metric, used by :func:`~taichi_forge.profiler.print_kernel_profiler_info`.
        val_format (str): format for print metric value (and unit of this value), used by :func:`~taichi_forge.profiler.print_kernel_profiler_info`.
        scale (float): scale of metric value, used by :func:`~taichi_forge.profiler.print_kernel_profiler_info`.
...
"""The metrics list, each is an instance of the :class:`~taichi_forge.profiler.CuptiMetric`.
