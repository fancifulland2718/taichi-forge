...
from taichi_forge.profiler.kernel_metrics import default_cupti_metrics
...
class KernelProfiler:
    ...
    and prints the results to the console by :func:`~taichi_forge.profiler.kernel_profiler.KernelProfiler.print_info`.
    ...
    def set_kernel_profiler_mode(self, mode=False):
        """Turn on or off :class:`~taichi_forge.profiler.kernel_profiler.KernelProfiler`."""
    ...
    def get_kernel_profiler_mode(self):
        """Get status of :class:`~taichi_forge.profiler.kernel_profiler.KernelProfiler`."""
    ...
    def clear_info(self):
        """Clear all records both in front-end :class:`~taichi_forge.profiler.kernel_profiler.KernelProfiler` and back-end instance ``KernelProfilerBase``.
    ...
    def query_info(self, name):
        """For docstring of this function, see :func:`~taichi_forge.profiler.query_kernel_profiler_info`."""
        if self._check_not_turned_on_with_warning_message():
            return None
        self._update_records()  # kernel records
    ...
    def set_metrics(self, metric_list=default_cupti_metrics):
        """For docstring of this function, see :func:`~taichi_forge.profiler.set_kernel_profiler_metrics`."""
        if self._check_not_turned_on_with_warning_message():
            return None
    ...
    def collect_metrics_in_context(self, metric_list=default_cupti_metrics):
        ...
        For usage of this function, see :func:`~taichi_forge.profiler.collect_kernel_profiler_metrics`.
        """
        if self._check_not_turned_on_with_warning_message():
            return None
    ...
    def print_info(self, mode=COUNT):
        ...
        For usage of this function, see :func:`~taichi_forge.profiler.print_kernel_profiler_info`.
    ...
    def _clear_frontend(self):
        """Clear member variables in :class:`~taichi_forge.profiler.kernel_profiler.KernelProfiler`.
...
def get_default_kernel_profiler():
    """We have only one :class:`~taichi_forge.profiler.kernelprofiler.KernelProfiler` instance(i.e. ``_ti_kernel_profiler``) now.
...
def set_kernel_profiler_metrics(metric_list=default_cupti_metrics):
    ...
    Args:
        metric_list (list): a list of :class:`~taichi_forge.profiler.CuptiMetric()` instances, default value: :data:`~taichi_forge.profiler.kernel_metrics.default_cupti_metrics`.
