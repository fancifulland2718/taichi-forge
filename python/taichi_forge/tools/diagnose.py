...
def main():
    ...
    def try_print(tag, expr):
        try:
            cmd = f'import taichi_forge as ti; print("===="); print({expr}, end="")'
    ...
    try:
        ti_header = subprocess.check_output([executable, "-c", "import taichi_forge"])
    except Exception as e:
        print(f"`import taichi_forge` failed: {e}")
    else:
        print(f"{ti_header.decode()}")

    try:
        ti_init_test = subprocess.check_output([executable, "-c", "import taichi_forge as ti; ti.init()"])
    except Exception as e:
    ...
    try:
        ti_opengl_test = subprocess.check_output([executable, "-c", "import taichi_forge as ti; ti.init(arch=ti.opengl)"])
    except Exception as e:
    ...
    try:
        ti_cuda_test = subprocess.check_output([executable, "-c", "import taichi_forge as ti; ti.init(arch=ti.cuda)"])
    except Exception as e:
    ...
    try:
        ti_laplace = subprocess.check_output([executable, "-m", "taichi_forge", "example", "minimal"])
    except Exception as e:
