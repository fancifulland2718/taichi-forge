...
def cmul(z1, z2):
    ...
    Args:
        z1 (:class:`~taichi_forge.math.vec2`): The first input.
        z2 (:class:`~taichi_forge.math.vec2`): The second input.
    ...
    Returns:
        :class:`~taichi_forge.math.vec2`: the complex multiplication `z1 * z2`.
    """
    x1, y1 = z1[0], z1[1]
    x2, y2 = z2[0], z2[1]
...
def cconj(z):
    ...
    Args:
        z (:class:`~taichi_forge.math.vec2`): The input.

    Returns:
       :class:`~taichi_forge.math.vec2`: The complex conjugate of `z`.
    """
    return vec2(z[0], -z[1])
...
def cdiv(z1, z2):
    ...
    Returns:
        :class:`~taichi_forge.math.vec2`: the complex division of `z1 / z2`.
    """
    x1, y1 = z1[0], z1[1]
    x2, y2 = z2[0], z2[1]
...
def csqrt(z):
    ...
    Returns:
        :class:`~taichi_forge.math.vec2`: The complex square root.
    """
    result = vec2(0.0)
    if any(z):
        r = ops.sqrt(z.norm())
...
def cinv(z):
    ...
    Returns:
        :class:`~taichi_forge.math.vec2`: The reciprocal of `z`.
    """
...
def cpow(z, n):
    ...
    Args:
        z (:class:`~taichi_forge.math.vec2`): The base.
    ...
    Returns:
        :class:`~taichi_forge.math.vec2`: The power :math:`z^a`.
    """
    result = vec2(0.0)
    if any(z):
        r2 = dot(z, z)
...
def cexp(z):
    ...
    Args:
        z (:class:`~taichi_forge.math.vec2`): The exponent.
    ...
    Returns:
        :class:`~taichi_forge.math.vec2`: The power :math:`exp(z)`
    """
    r = ops.exp(z[0])
...
def clog(z):
    ...
    Returns:
        :class:`~taichi_forge.math.vec2`: The logarithm of `z`.
    """
