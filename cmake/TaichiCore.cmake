...
if (TI_WITH_VULKAN)
    ...
    ti_vulkan_sort_shader(scatter_add_i32_by_i32.comp scatter_add_i32_by_i32.comp.spv.h "-DVALUE_KIND=0")
    ti_vulkan_sort_shader(scatter_add_i32_by_i32.comp scatter_add_f32_by_i32.comp.spv.h "-DVALUE_KIND=1")
    ti_vulkan_sort_shader(scatter_add_i32_by_i32.comp scatter_add_u32_by_i32.comp.spv.h "-DVALUE_KIND=2")
    ti_vulkan_sort_shader(scatter_add_i32_by_i32.comp scatter_add_u64_by_i32.comp.spv.h "-DVALUE_KIND=3")
    ti_vulkan_sort_shader(scatter_add_i32_by_i32.comp scatter_add_i64_by_i32.comp.spv.h "-DVALUE_KIND=4")
    ti_vulkan_sort_shader(scatter_add_i32_by_i32.comp scatter_add_f64_by_i32.comp.spv.h "-DVALUE_KIND=5")
    ti_vulkan_sort_shader(scatter_add_i32_by_i32.comp scatter_add_i32_by_i32_strided.comp.spv.h "-DVALUE_KIND=0" "-DSTRIDED_SOURCE=1")
    ti_vulkan_sort_shader(scatter_add_i32_by_i32.comp scatter_add_f32_by_i32_strided.comp.spv.h "-DVALUE_KIND=1" "-DSTRIDED_SOURCE=1")
    ti_vulkan_sort_shader(scatter_add_i32_by_i32.comp scatter_add_u32_by_i32_strided.comp.spv.h "-DVALUE_KIND=2" "-DSTRIDED_SOURCE=1")
    ti_vulkan_sort_shader(scatter_add_i32_by_i32.comp scatter_add_u64_by_i32_strided.comp.spv.h "-DVALUE_KIND=3" "-DSTRIDED_SOURCE=1")
    ti_vulkan_sort_shader(scatter_add_i32_by_i32.comp scatter_add_i64_by_i32_strided.comp.spv.h "-DVALUE_KIND=4" "-DSTRIDED_SOURCE=1")
    ti_vulkan_sort_shader(scatter_add_i32_by_i32.comp scatter_add_f64_by_i32_strided.comp.spv.h "-DVALUE_KIND=5" "-DSTRIDED_SOURCE=1")
